...
class Twitter_Form extends Zend_Form
{
	...
	public function __construct($options = null)
	{
        ...
        $this->addPrefixPath('Twitter_Form_Element', 'Twitter/Form/Element', 'element');
    ...
    public function addDisplayGroup(array $elements, $name = 'main', $options = null)
    {
	...
	protected function _addActionsDisplayGroupElement($element)
	{
		...
		if($displayGroup === null)
		{
			...
			$displayGroup = $this->addDisplayGroup(
				...
				array(
					"decorators" => array(
						'FormElements',
						array("Fieldset", array("class" => "form-actions"))
					)
				));
		}
		else
